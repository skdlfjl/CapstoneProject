...
public class MainActivity extends AppCompatActivity {
    ...
    String[] token = {"1111","2222","3333","4444","5555"};   //이걸 데이터베이스에서 가져와야 합니다 (수정필요!!!!!!) token_dict의 tokens에서 가져옵니다
    int where;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // token_dict에서 일단 입력된 토큰(str변수에 저장했네요)을 key값으로 이용하게 됩니다.
        // token_dict의 tokens를 사용하게 되는데, tokens[str] 값이 0이면 학번쓰는 페이지 sub로 넘어가고, 1이면 투표 완료페이지로 가야합니다.
        ...
        // 위와 구현방법이 거의 동일합니다.
        // 사용되는 토큰을 저장해둔 token_dict의 tokens의 토큰이 0일 경우, 페이지가 넘어갑니다.
