...
public class SearchActivity extends AppCompatActivity {
    ...
    String[] student_id = {"20171478","20181234","20192345","20205532","20213356","33","33333","333333","1223123","233","1111111"};  //임시임
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // str변수에는 투표로 이동할 수 있는 token이 담겨있습니다.
        // token_dict의 search를 사용해서, edittext에 입력된 관리자용 token이 맞는지 확인해야합니다.
        // 대충 적어보면 search[str] == (edittext에 입력된 관리자용 token)
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //여기서 원래 if문을 써야합니다링
                //search[str] == (edittext에 입력된 관리자용 token)
